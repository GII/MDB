...
from core_interfaces.srv import SendToCommander
...
class SendToCommanderClient(Node):
    ...
    Attributes:
        ...
        req (:class:`core_interfaces.srv.SendToCommander.Request`): A request for the service.
    ...
    def send_request(self, command, name, type, data):
        ...
        :rtype: core_interfaces.srv.SendToCommander.Response
        """
