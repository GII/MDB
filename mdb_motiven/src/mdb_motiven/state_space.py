...
class StateSpace(object):
    ...
    def __init__(self):
        ...
        self.object_1 = patches.Circle(
            (15, 15), 3, fc=(0.8, 0, 0, 0.6)
        )  # 0.8 # Represents the object position in SS in t-1
        self.object_2 = patches.Circle(
            (15, 15), 3, fc=(0.8, 0, 0, 0.2)
        )  # 0.6 # Represents the object position in SS in t-2
        ...
        self.object_1b = patches.Circle(
            (215, 15), 3, fc=(0.8, 0, 0, 0.6)
        )  # 0.8 # Represents the object position in SS in t-1
        self.object_2b = patches.Circle(
            (215, 15), 3, fc=(0.8, 0, 0, 0.2)
        )  # 0.6 # Represents the object position in SS in t-2
